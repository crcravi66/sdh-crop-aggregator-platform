...
const index = () => {
  return (
    <div className="min-h-screen w-full flex flex-col bg-[#4a3aff] text-white">
      {/* Status Bar
    ...
    <div className='  sm:mx-auto flex-col min-w-72 sm:w-96 sm:px-2 flex justify-around '>
      ...
      <div className="flex items-center px-6 py-4">
        ...
        <div className="ml-auto">
          {/* <img src="https://dashboard.codeparrot.ai/api/image/Z5EBh3hIZI-ZK8b7/icon-4.png" alt="Notifications" /> */}
    ...
    <div className="flex flex-col px-6 gap-6 w-full "> 
      ...
      <div className="relative my-4 flex items-center w-full">
        ...
        />
        <img src="https://dashboard.codeparrot.ai/api/image/Z5EDX73tvuKvN6XS/icon.png" alt="search" className="absolute right-3 w-6 h-6" />
      </div>
      ...
      <div className="px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <p className="text-xs text-blue-300">See all</p>
        </div>
      ...
      <div className="flex flex-col space-y-4 px-6 py-4">
        <div className="flex items-center bg-white text-black p-4 rounded-lg">
      ...
      <div className="flex items-center justify-between px-6 py-2">
        ...
        <div className="relative">
          <div className="flex items-center  bg-[#4A3AFF] rounded-xl px-4 py-2 w-[92px] h-[36px]">
            ...
            />
            <span className="text-white mr-2 font-poppins text-xs font-normal">
              Home
            </span>
          </div>
        </div>
