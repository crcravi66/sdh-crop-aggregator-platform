        ...
        <div className=' mx-auto flex-col min-w-72 sm:w-96 px-2 flex justify-around '>
            <div className="text-xs mt-1 font-medium text-gray-500 text-center">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <span className="text-xs font-semibold  text-gray-800 text-right">Ameta, Dist-Barmer<br />Rajasthan 344001</span>
                    </div>
                    <div className="flex justify-between">
                    <span className="text-xs font-semibold text-gray-500">Expected Harvest<br />Date</span>
