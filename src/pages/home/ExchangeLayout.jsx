        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex justify-center items-center">
            <div className="flex gap-3">
                <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/228BE6/long-arrow-down.png" alt="long-arrow-down"/>              {/* <img src="https://dashboard.codeparrot.ai/api/image/Z5Ix5vA8XwfbJP9G/color-bu.png" alt="arrow down" className="w-6 h-6" /> */}
                <img width="40" height="28" src="https://img.icons8.com/external-tanah-basah-basic-outline-tanah-basah/24/FA5252/external-up-arrow-arrows-tanah-basah-basic-outline-tanah-basah.png" alt="external-up-arrow-arrows-tanah-basah-basic-outline-tanah-basah"/>            </div>
          </div>
